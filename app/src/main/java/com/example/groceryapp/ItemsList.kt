...
import com.example.groceryapp.databinding.FragmentItemsListBinding
...
class ItemsList : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentItemsListBinding.inflate(layoutInflater)

        binding.btnAdd.setOnClickListener {
           llMainActivity.navController.navigate(R.id.addCategory)
        }
        adapter = ItemsListAdapter(llMainActivity.itemsList)
